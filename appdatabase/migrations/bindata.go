...
func _1605007189_identity_imagesDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1605007189_identity_images.down.sql", size: 29, mode: os.FileMode(0644), modTime: time.Unix(1607535477, 0)}
...
func _1605007189_identity_imagesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1605007189_identity_images.up.sql", size: 224, mode: os.FileMode(0644), modTime: time.Unix(1607535477, 0)}
