...
func ConfigReadmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/README.md", size: 3153, mode: os.FileMode(0644), modTime: time.Unix(1600263830, 0)}
...
func ConfigCliFleetEthProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.prod.json", size: 4925, mode: os.FileMode(0644), modTime: time.Unix(1600263830, 0)}
...
func ConfigCliFleetEthStagingJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.staging.json", size: 2307, mode: os.FileMode(0644), modTime: time.Unix(1600263830, 0)}
...
func ConfigCliFleetEthTestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-eth.test.json", size: 2315, mode: os.FileMode(0644), modTime: time.Unix(1600263830, 0)}
