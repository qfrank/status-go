...
import (
	...
	communities_migrations "github.com/status-im/status-go/protocol/communities/migrations"
...
var defaultMigrations = []migrationsWithGetter{
	...
	{
		Names:  communities_migrations.AssetNames(),
		Getter: communities_migrations.Asset,
	},
}
