...
func _1602502752_initial_schemaDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1602502752_initial_schema.down.sql", size: 40, mode: os.FileMode(0644), modTime: time.Unix(1602767397, 0)}
...
func _1602502752_initial_schemaUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1602502752_initial_schema.up.sql", size: 203, mode: os.FileMode(0644), modTime: time.Unix(1602767402, 0)}
...
func docGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc.go", size: 382, mode: os.FileMode(0644), modTime: time.Unix(1602767397, 0)}
